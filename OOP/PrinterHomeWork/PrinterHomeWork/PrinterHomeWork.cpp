...
public:
	...
	unsigned short queue_size() const
	{
		return queue_size_;
	}
	...
	void set_queue_size(const unsigned short queue_size)
	{
...
public:
	...
	{
		call_stack.push(*client);
	}

	void print()
	{
		printer_->print(*call_stack.pop(), this->printer_);
	}
